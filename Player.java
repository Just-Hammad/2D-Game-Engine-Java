public class Player extends Mob {
    ...
    private enum PlayerColour {
        RED(963), GREEN(386), BLUE(259), YELLOW(-1), CYAN(368), MAGENTA(838), WHITE(889);

        private int colour;

        PlayerColour(int colour) {
            this.colour = colour;
        }
        ...
        public static int fromString (String colour) {
            switch (colour.toUpperCase()) {
                case "RED":
                    return RED.getColour();
                case "GREEN":
                    return GREEN.getColour();
                case "BLUE":
                    return BLUE.getColour();
                case "YELLOW":
                    return YELLOW.getColour();
                case "CYAN":
                    return CYAN.getColour();
                case "MAGENTA":
                    return MAGENTA.getColour();
                case "WHITE":
    ...
    private long colour = Colours.get(-1, 111, PlayerColour.fromString(playerColour), -1);
    private int scale = 1;
